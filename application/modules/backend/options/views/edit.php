		  ...
		  <h3 class="box-title">Edit <?php echo $sub_title;?></h3>
			...
			<?php show_alert('danger',$this->session->flashdata('danger_message'));?>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-6"><input value="<?php set_value_edit_text(wd_set_value('name'),$list['name']); ?>" type="text" class="form-control" name="name" id="name" placeholder="Name" size="50" disabled>			  
				</div>
				</div>
